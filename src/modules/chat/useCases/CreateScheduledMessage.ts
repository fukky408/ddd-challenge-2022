...
import { ScheduleStatus, ScheduleStatusCandidate } from "../domain/ScheduleStatus";
...
export class CreateScheduledMessage implements UseCase<Request, Promise<Response>> {
  constructor(
